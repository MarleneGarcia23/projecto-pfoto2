...
<footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?= date('Y') ?> <a href="http://sistemahospitalar.com">Sistema Hospitalar</a>.</strong> Todos Direitos Reservados.
</footer>
</div>
    ...
    <script>
        ...
        labels: ["<?= $dados['grafico1'][0]['mes'] ?>", "<?= $dados['grafico1'][1]['mes'] ?>", "<?= $dados['grafico1'][2]['mes'] ?>"],
                ...
                label: 'Pagamento E Venda',
                        ...
                        data: [<?= $dados['grafico1'][0]['totalpagvenda'] ?>,<?= $dados['grafico1'][1]['totalpagvenda'] ?>, <?= $dados['grafico1'][2]['totalpagvenda'] ?>]
                },
                {
                label: 'Compra',
...
//Calendario de Agenda
                    function getagenda() {
                    $.post(base_url + 'agenda/getagenda',
                    {}, function (data) {
