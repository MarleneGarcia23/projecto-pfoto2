        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <form role="form" action="<?= base_url() ?>correio/cadastrar" method="post" enctype="multipart/form-data">
                        <div class="box-header with-border">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <input type="email" name="email" class="form-control" placeholder="Para:" required>
                            </div>
                            <div class="form-group">
