    ...
    <section class="invoice">
        ...
        <div class="row">
            <div class="col-xs-12 table-responsive">
                ...
                <table class="table table-condensed table-bordered table-striped table-hover table-form" id="table-itempagamento">
                    <form id="form-itempagamento">
                        <thead>
                            <tr>
                                <th>Item</th>
                            ...
                            <tr>
                                <td>
                                    <input type="text" class="hidden" name="itempagamento-id" value="0">
                                    <select class="form-control" name="itempagamento-designcacao" onclick="getitempagamento();" required>
                                ...
                                <td>
                                    <input type="text" class="form-control input-sm" placeholder="Unidade" name="itempagamento-unidade" value="AOA" readonly>
                                </td>
                                <td>
                                    <input type="text" step="any" class="form-control input-sm" placeholder="preco" name="itempagamento-preco" value="0" readonly>
                                </td>
                                <td>
                                    <input type="text" step="any" class="form-control input-sm" placeholder="qtd" name="itempagamento-qtd" onkeyup="calcular_itempagamentodetalhe();" value="0" required>
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control input-sm" placeholder="imposto" name="itempagamento-imposto" value="0" readonly>
                                </td>
                                <td>
                                    <input type="number" step="any" min="100" class="form-control input-sm" name="itempagamento-subtotal" value="0" readonly>
                                </td>
                                <td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td>
                                <input type="number" step="any" class="form-control input-sm" name="itempagamento-total" value="0" readonly>
                            </td>
                            <td></td>
                        </tr>
                    </tfoot>
        ...
        <div class="row">
            ...
            <div class="col-xs-6">
                ...
                <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
                    <textarea name="nota" style="margin: 0px -17.6563px 0px 0px; width: 100%;  height: 143px;" placeholder="Escrever Nota"></textarea>
                </p>
            </div>
            <!-- /.col -->
            <div class="col-xs-6">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            <th>Valor a Pagar</th>
                            <td><input type="text" step="any" class="form-control input-sm" name="valorpago" onkeyup="itempagamento_total();" value="0" required></td>
                        </tr>
                        <tr>
                            <th>Imposto</th>
                        ...
                        <tr>
                            <th>Desconto (AKZ)</th>
                            <td><input type="text" step="any" class="form-control input-sm" name="desconto" onkeyup="itempagamento_total();" value="0" required></td>
                        </tr>
                        <tr>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <form action="<?= base_url() ?>home" method="post">
                    <button type="button" name="salvar" onclick="salvar_itempagamento();" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i>
                        Efectuar Pagamento
                    </button>
