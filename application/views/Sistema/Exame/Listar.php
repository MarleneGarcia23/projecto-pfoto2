            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <a href="  <?= base_url() ?>exame/nova" class="btn btn-primary pull-left" style="margin-right: 5px; margin-top: 15px;">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($dados["exame"] as $valor) { ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a href="<?= base_url(); ?>exame/editar/<?= $valor->id; ?>" class="btn btn-instagram">Editar</a>
												<a onclick="(confirm('Pretende efetuar esta operacão')==true)?location.href='<?= base_url(); ?>exame/eliminar/<?= $valor->id; ?>':''"  class="btn btn-danger">Eliminar</a>          
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
