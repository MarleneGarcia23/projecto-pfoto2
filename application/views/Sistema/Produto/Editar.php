        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="<?= base_url() ?>produto/actualizar" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $dados[0]->id ?>" />
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">Designação</label>
                                    <input type="text" class="form-control"  name="designacao" value="<?= $dados[0]->designacao ?>" placeholder="Produto" required>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="preco1" value="<?= $dados[0]->preco1 ?>" placeholder="Ex: 1000.00 " required>
                                    <span class="input-group-addon">.00</span>
                                </div><br>
                                <label >Preco de Venda</label>
                                <div class="input-group">
                                    <span class="input-group-addon">$</span>
                                    <input type="text" class="form-control" name="preco2"  value="<?= $dados[0]->preco2 ?>" placeholder="Ex: 1000.00 " required>
                                    <span class="input-group-addon">.00</span>
                                </div>
                            </div>
                            <div class="col-md-12">
