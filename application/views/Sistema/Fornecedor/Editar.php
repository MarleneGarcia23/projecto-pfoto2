        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="<?= base_url() ?>fornecedor/actualizar" method="post">
                        <input type="hidden" name="id" value="<?= $dados[0]->id ?>" />
                        <div class="box-body">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="">Designação</label>
                                    <input type="text" class="form-control"  name="designacao" value="<?= $dados[0]->designacao ?>" placeholder="Departamento" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label >Nif</label>
                                <input type="text" class="form-control"  name="nif" value="<?= $dados[0]->nif ?>" placeholder="Nif" required>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
