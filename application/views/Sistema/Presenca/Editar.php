        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="<?= base_url() ?>presenca/actualizar" method="post">
                        <input type="hidden" name="id" value="<?= $dados['presenca'][0]->idpresenca ?>" />
                        <div class="box-body">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="descricao" style="margin: 0px -17.6563px 0px 0px;  height: 143px;"><?= $dados['presenca'][0]->descricao ?></textarea>
                                </div>
                            </div>
                        </div>
